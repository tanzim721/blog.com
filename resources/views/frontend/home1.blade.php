    ...
    <div class="latest-blog">
        <div class="container contact-info-left">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1 class="text-danger">______Our Location______</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8">
                    <div class="blog-box">
                        @foreach($locations as $location)
                            <iframe src="{{$location->long_title}}" width="100%" height="320" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        @endforeach
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 col-xl-2"></div>
