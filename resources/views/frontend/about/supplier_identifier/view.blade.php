                ...
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        <strong>
                            ...
                            <li class="breadcrumb-item active">Supplier Identifier</li>
                        </strong>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            <button data-filter=".supplierIdentifier"><strong>Supplier Identifier</strong></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shop-cat-box" style="border:20px solid #b0b54d;">      
                        <img class="img-fluid" src="{{asset('upload/supplier_identifiers_images/'.$supplierIdentifier->image)}}" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h1 class="noo-sh-title-top text-danger"><strong>Supplier Identifiers</strong></h1>
                    <h2>{{$supplierIdentifier->short_title}}</h2>
                    <h2>{{$supplierIdentifier->long_title}}</h2>
                </div>
                @endforeach
            </div>
        </div>
