    ...
    <div class="products-box">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="noo-sh-title-top"><strong>{{$AopOne->short_title}}</strong></h1>
                    @foreach($AopOneLists as $AopOneList)
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-xl-3">
                            <h2><strong><span style="color:red;"></span><i class="fa-solid fa-list text-danger"></i> {{$AopOneList->short_title}}</strong></h2>
                            <ul>
                                <li><strong><span style="color:red;"></span> {{$AopOneList->long_title}}</strong></li>
                            </ul>
                        </div>
