            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            Edit AOP
                            <a class="btn btn-success btn-sm" href="{{route('panel.aop_one_lists.view')}}" style="float:right;"><i class="bi bi-list"></i> AOP list</a>
                        </h5>
                        <br>
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{route('panel.aop_one_lists.update',$editData->id)}}" method="post" id="myForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-12">
