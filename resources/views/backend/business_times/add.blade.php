    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Add Time</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{route('panel.business_times.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" value=""  name="time" class="form-control" id="time">
                            </div>
