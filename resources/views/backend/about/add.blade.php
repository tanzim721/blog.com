            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{route('panel.abouts.store')}}" method="post" id="myForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="cl-12">
                            <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Image</label>
                                <div class="col-md-8 col-lg-9">
                                    <img src="{{(!empty($editData->image))?url('upload/about_images/',$editData->image):asset('upload/no_image.png')}}" alt="Profile" id="showImage" style="height:160px; width:160px;">
                                    <div class="pt-2">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" value="" name="ceo_name" class="form-control" id="datepicker">
                            </div>
                            <div class="col-12">
