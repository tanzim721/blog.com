            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            Edit AOP
                            <a class="btn btn-success btn-sm" href="{{route('panel.aop_twos.view')}}" style="float:right;"><i class="bi bi-list"></i> AOP list</a>
                        </h5>
                        <br>
                        <!-- Vertical Form -->
                        <form class="row g-3" action="{{route('panel.aop_twos.update',$editData->id)}}" method="post" id="myForm" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-12">
                                <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Image</label>
                                <div class="col-md-8 col-lg-9">
                                    <img src="{{(!empty($editData->image))?url('upload/aop_twos_images/',$editData->image):asset('upload/no_image.png')}}" alt="Profile" id="showImage" style="height:120px; width:120px;">
                                    <div class="pt-2">
